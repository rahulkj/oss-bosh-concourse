...
git clone https://github.com/cloudfoundry-community/logsearch-boshrelease $__BASE_DIR__/logsearch-boshrelease

pushd $__BASE_DIR__/logsearch-boshrelease/deployment
...
bosh int logsearch-deployment.yml \
  ...
  -v system_domain="sys.cloudlab.io"
